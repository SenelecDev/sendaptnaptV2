...
return [
    ...
    */
    ...
    'custom' => [
        'charge_travaux_id' => [
            'exists' => 'Le chargé de travaux sélectionné est invalide.',
            'required' => 'Veuillez sélectionner ou ajouter un chargé de travaux.',
        ],
        'demandeur_id' => [
            'exists' => 'Le demandeur sélectionné est invalide.',
            'required' => 'Veuillez sélectionner un demandeur.',
        ],
        'lieu_execution' => [
            'required' => 'Le lieu d\'exécution est obligatoire.',
        ],
        'designation' => [
            'required' => 'La désignation des travaux est obligatoire.',
        ],
        'ddp' => [
            'required' => 'La date de début prévue est obligatoire.',
        ],
        'dfp' => [
            'required' => 'La date de fin prévue est obligatoire.',
            'after_or_equal' => 'La date de fin doit être égale ou postérieure à la date de début.',
        ],
        'schema' => [
            'mimes' => 'Le schéma doit être une image (PNG, JPG ou JPEG uniquement). Les fichiers PDF ne sont pas acceptés.',
            'max' => 'Le schéma ne doit pas dépasser 10 Mo.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'lieu_execution_manuel' => 'lieu d\'exécution',
        'ddp' => 'date de début prévue',
        'hdp' => 'heure de début prévue',
        'dfp' => 'date de fin prévue',
        'hfp' => 'heure de fin prévue',
        'mode_saisie' => 'mode de saisie',
        'mte' => 'mise à la terre aux extrémités',
        'mcce' => 'mise en court-circuit aux extrémités',
        'etape' => 'étape',
        'demandeur_id' => 'demandeur',
        'charge_travaux_id' => 'chargé de travaux',
        'renseignement' => 'renseignements',
        'schema' => 'schéma',
        'telephone_demandeur' => 'téléphone du demandeur',
        'telephone_charge' => 'téléphone du chargé de travaux',
        'ouvrage_type' => 'type d\'ouvrage',
        'ouvrages_consigner_manuel' => 'ouvrages à consigner',
        'ouvrages_installer_manuel' => 'ouvrages à installer',
        'ct_externe_nom' => 'nom du chargé de travaux externe',
        'ct_externe_telephone' => 'téléphone du chargé de travaux externe',
        'ct_externe_entreprise' => 'entreprise du chargé de travaux externe',
        'ct_externe_service' => 'service du chargé de travaux externe',
        'statut' => 'statut',
