        ...
        <div class="rounded-2xl shadow-lg overflow-hidden border border-gray-100 bg-white">
            ...
            <div class="p-3">
                <div class="grid grid-cols-5 gap-1" style="display: grid; grid-template-columns: repeat(5, minmax(0, 1fr)); gap: 0.25rem;">
                    ...
                    <a href="{{ route('operateur.notes.index', ['statut' => 'validée', 'date_debut' => $debutSemaineM1->format('Y-m-d'), 'date_fin' => $finSemaineM1->format('Y-m-d')]) }}" class="text-center p-2 bg-blue-50 rounded hover:bg-blue-100 transition-colors">
                        <p class="text-lg font-bold text-blue-600">{{ $statsSemaineM1['a_executer'] }}</p>
                        <p class="text-[10px] text-gray-500">À exéc.</p>
                    </a>
                    <a href="{{ route('operateur.notes.index', ['statut' => "en cours d'exécution", 'date_debut' => $debutSemaineM1->format('Y-m-d'), 'date_fin' => $finSemaineM1->format('Y-m-d')]) }}" class="text-center p-2 bg-orange-50 rounded hover:bg-orange-100 transition-colors">
                        <p class="text-lg font-bold text-orange-600">{{ $statsSemaineM1['en_cours'] }}</p>
                        <p class="text-[10px] text-gray-500">En cours</p>
                    </a>
                    <a href="{{ route('operateur.notes.index', ['statut' => 'exécutée', 'date_debut' => $debutSemaineM1->format('Y-m-d'), 'date_fin' => $finSemaineM1->format('Y-m-d')]) }}" class="text-center p-2 bg-emerald-50 rounded hover:bg-emerald-100 transition-colors">
                        <p class="text-lg font-bold text-emerald-600">{{ $statsSemaineM1['executees'] }}</p>
                        <p class="text-[10px] text-gray-500">Exec.</p>
                    </a>
                    <a href="{{ route('operateur.notes.index', ['statut' => 'annulée', 'date_debut' => $debutSemaineM1->format('Y-m-d'), 'date_fin' => $finSemaineM1->format('Y-m-d')]) }}" class="text-center p-2 bg-gray-100 rounded hover:bg-gray-200 transition-colors">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">À exécuter</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-center">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                {{ $statsSemaineCourante['a_executer'] }}
                            </span>
                        </td>
                        <td class="px-6 py-4 text-center">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-emerald-100 text-emerald-800">
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [
                ...
                {
                    label: 'À exécuter',
                    data: [{{ $statsSemaineM1['a_executer'] }}, {{ $statsSemaineCourante['a_executer'] }}, {{ $statsSemaineS1['a_executer'] }}],
