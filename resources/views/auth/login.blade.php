...
<head>
    ...
    <title>Connexion - SENDAPTNAPT SENELEC</title>
    ...
    <style>
        ...
        /* Police Rajdhani pour les autres titres */
        .font-title {
        ...
        /* Button styling - Gradient Violet vers Magenta */
        .login-btn {
        ...
        /* Gradient text - Violet vers Magenta (pour fond clair) */
        .text-gradient {
            background: linear-gradient(135deg, #2B1444 0%, #B3006C 100%);
        ...
        /* Gradient text pour fond sombre - Style SMART SENELEC (jaune → orange → magenta → cyan) */
        .text-gradient-light {
...
<body class="m-0 p-0 overflow-hidden" style="min-height: 100vh; height: 100vh;">
    <!-- Page entière avec image de fond + overlay -->
    <div class="fixed inset-0 flex items-center justify-center p-4 md:p-6"
        ...
        <!-- Overlay gradient violet-magenta (même que le bouton) -->
        <div class="absolute inset-0" style="background: linear-gradient(135deg, rgba(43, 20, 68, 0.75) 0%, rgba(179, 0, 108, 0.7) 100%);"></div>
            ...
            <div class="flex flex-row w-full justify-between items-center">
                ...
                <div class="flex-1 flex flex-col justify-center pr-4 text-white">
                    ...
                    <p class="text-lg md:text-xl xl:text-2xl font-semibold mb-4" style="font-family: 'Open Sans', sans-serif;">
                        Gestion des Demandes et Notes d'Arrêt Pour Travaux
                    </p>
                    
                    <p class="text-sm md:text-base text-white/80 max-w-md mb-4" style="font-family: 'Open Sans', sans-serif;">
                        Gérez vos demandes DAPT, suivez les notes NAPT et assurez la sécurité des interventions sur le réseau électrique.
                    </p>
