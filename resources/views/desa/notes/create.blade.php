            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="text" name="numero_note" id="numero_note" 
                           ...
                           placeholder="Ex: 00001-SME-2026" 
                           value="{{ old('numero_note') }}" required>
                    @if($dernierNumeroNapt)
                    <p class="mt-1 text-xs font-bold text-red-600">Dernier NAPT créé : <span class="text-base">{{ $dernierNumeroNapt }}</span></p>
                    @endif
                    @error('numero_note')
