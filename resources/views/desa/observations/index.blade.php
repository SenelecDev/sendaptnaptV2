...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 font-['Rajdhani']">Observations</h1>
            <p class="text-gray-600">Retours et suggestions des utilisateurs</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <a href="{{ route($routePrefix . '.observations.index', ['lu' => '0']) }}" class="stat-card-orange hover:scale-105 transition-transform cursor-pointer">
    ...
    <div class="card-senelec p-4">
        <form method="GET" action="{{ route($routePrefix . '.observations.index') }}" class="flex flex-wrap items-end gap-4">
            ...
            <div class="w-32">
                <label class="label">Statut lu</label>
                <select name="lu" class="select-senelec w-full">
                    ...
                    @forelse($observations as $observation)
                        <tr class="hover:bg-gray-50 transition-colors {{ !$observation->lu ? 'bg-blue-50' : '' }}">
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                @else
                                    <span class="inline-flex items-center justify-center w-3 h-3 bg-gray-300 rounded-full"></span>
                                @endif
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">
                                    {{ $observation->user->name ?? 'N/A' }}
                                </div>
                                <div class="text-xs text-gray-500">
                                    {{ $observation->user->matricule ?? '' }}
                                </div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="{{ route($routePrefix . '.observations.show', $observation) }}" 
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="px-6 py-12 text-center text-gray-500">
                                ...
                                <p class="mt-2">Aucune observation trouvée</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
