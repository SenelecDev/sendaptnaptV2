        ...
        <div class="rounded-2xl shadow-lg overflow-hidden border border-gray-100 bg-white">
            ...
            <div class="p-4">
                <div class="grid grid-cols-5 gap-2" style="display: grid; grid-template-columns: repeat(5, minmax(0, 1fr)); gap: 0.5rem;">
                    ...
                    <a href="{{ route('operateurchef.notes.index', ['statut' => 'validée', 'date_debut' => $debutSemaine->format('Y-m-d'), 'date_fin' => $finSemaine->format('Y-m-d')]) }}" class="text-center p-3 bg-green-50 rounded-lg hover:bg-green-100 transition-colors cursor-pointer">
                        <p class="text-2xl font-bold text-green-600">{{ $statsSemaineCourante['validees'] }}</p>
                        <p class="text-xs text-gray-500">Validées</p>
                    </a>
                    <a href="{{ route('operateurchef.notes.index', ['statut' => "en cours d'exécution", 'date_debut' => $debutSemaine->format('Y-m-d'), 'date_fin' => $finSemaine->format('Y-m-d')]) }}" class="text-center p-3 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors cursor-pointer">
                        <p class="text-2xl font-bold text-orange-600">{{ $statsSemaineCourante['en_cours'] }}</p>
                        <p class="text-xs text-gray-500">En cours</p>
                    </a>
                    <a href="{{ route('operateurchef.notes.index', ['statut' => 'exécutée', 'date_debut' => $debutSemaine->format('Y-m-d'), 'date_fin' => $finSemaine->format('Y-m-d')]) }}" class="text-center p-3 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors cursor-pointer">
                        <p class="text-2xl font-bold text-emerald-600">{{ $statsSemaineCourante['executees'] }}</p>
                        <p class="text-xs text-gray-500">Exécutées</p>
                    </a>
                    <a href="{{ route('operateurchef.notes.index', ['statut' => 'annulée', 'date_debut' => $debutSemaine->format('Y-m-d'), 'date_fin' => $finSemaine->format('Y-m-d')]) }}" class="text-center p-3 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors cursor-pointer">
        ...
        <div class="rounded-2xl shadow-lg overflow-hidden border border-gray-100 bg-white">
            ...
            <div class="p-4">
                ...
                <div class="grid grid-cols-5 gap-2" style="display: grid; grid-template-columns: repeat(5, minmax(0, 1fr)); gap: 0.5rem;">
                    ...
                    <a href="{{ route('operateurchef.notes.index', ['statut' => 'validée', 'date_debut' => $debutSemaineS1->format('Y-m-d'), 'date_fin' => $finSemaineS1->format('Y-m-d')]) }}" class="text-center p-3 bg-green-50 rounded-lg hover:bg-green-100 transition-colors cursor-pointer">
                        <p class="text-2xl font-bold text-green-600">{{ $statsSemaineS1['validees'] }}</p>
                        <p class="text-xs text-gray-500">Validées</p>
                    </a>
                    <a href="{{ route('operateurchef.notes.index', ['statut' => "en cours d'exécution", 'date_debut' => $debutSemaineS1->format('Y-m-d'), 'date_fin' => $finSemaineS1->format('Y-m-d')]) }}" class="text-center p-3 bg-orange-50 rounded-lg hover:bg-orange-100 transition-colors cursor-pointer">
                        <p class="text-2xl font-bold text-orange-600">{{ $statsSemaineS1['en_cours'] }}</p>
                        <p class="text-xs text-gray-500">En cours</p>
                    </a>
                    <a href="{{ route('operateurchef.notes.index', ['statut' => 'exécutée', 'date_debut' => $debutSemaineS1->format('Y-m-d'), 'date_fin' => $finSemaineS1->format('Y-m-d')]) }}" class="text-center p-3 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors cursor-pointer">
                        <p class="text-2xl font-bold text-emerald-600">{{ $statsSemaineS1['executees'] }}</p>
                        <p class="text-xs text-gray-500">Exécutées</p>
                    </a>
                    <a href="{{ route('operateurchef.notes.index', ['statut' => 'annulée', 'date_debut' => $debutSemaineS1->format('Y-m-d'), 'date_fin' => $finSemaineS1->format('Y-m-d')]) }}" class="text-center p-3 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors cursor-pointer">
