                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    @endif
                                    @if($demande->demandeur_id == Auth::id() && in_array($demande->statut, ['créée', 'retournée', 'brouillon']))
                                    ...
                                    @endif
                                    @if($demande->demandeur_id == Auth::id() && in_array($demande->statut, ['brouillon', 'créée']) && !$demande->note)
                                        <button type="button" 
