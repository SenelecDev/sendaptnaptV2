...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <h1 class="text-2xl font-bold text-gray-900">Créer un groupe</h1>
    </div>

    <!-- Formulaire -->
    <form action="{{ route('admin.groupes.store') }}" method="POST" class="card-senelec space-y-6">
        @csrf
        ...
        <div>
            ...
            <input type="text" name="nom" id="nom" value="{{ old('nom') }}" required
                   placeholder="Ex: Équipe DESA, Opérateurs Nord..."
