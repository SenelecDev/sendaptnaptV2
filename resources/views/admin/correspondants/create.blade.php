...
@section('title', 'Nouveau correspondant')
...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Nouveau correspondant</h1>
            <p class="text-gray-600">Ajouter un nouveau correspondant</p>
        </div>
    </div>

    <!-- Formulaire -->
    <div class="card-senelec">
        <form action="{{ route('admin.correspondants.store') }}" method="POST">
            @csrf
