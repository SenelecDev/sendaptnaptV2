...
@section('title', 'Nouveau chargé de consignation')
...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Nouveau chargé de consignation</h1>
            <p class="text-gray-600">Ajouter un nouveau chargé de consignation</p>
        </div>
    </div>

    <!-- Formulaire -->
    <div class="card-senelec">
        <form action="{{ route('admin.chargecons.store') }}" method="POST">
            @csrf
