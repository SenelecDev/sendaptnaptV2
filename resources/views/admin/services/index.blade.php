...
@section('title', 'Services destinataires')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Services destinataires</h1>
            <p class="text-gray-600">{{ $services->total() }} service(s) au total</p>
        </div>
        <a href="{{ route('admin.services.create') }}" class="btn-senelec inline-flex items-center gap-2">
        ...
        <form method="GET" action="{{ route('admin.services.index') }}" class="flex gap-4">
            <div class="flex-1">
                <input type="text" name="search" value="{{ request('search') }}" 
                       placeholder="Rechercher par nom, responsable ou email..." class="input">
            </div>
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10 bg-senelec-green/10 rounded-full flex items-center justify-center">
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-6 py-12 text-center">
                            ...
                            <p class="mt-2 text-gray-500">Aucun service destinataire trouvé</p>
                            <a href="{{ route('admin.services.create') }}" class="mt-4 inline-block btn-senelec">
                                Ajouter un service
                            </a>
                        </td>
                    </tr>
