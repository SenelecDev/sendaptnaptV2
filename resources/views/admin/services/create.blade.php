...
@section('title', 'Nouveau service destinataire')
...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Nouveau service destinataire</h1>
            <p class="text-gray-600">Ajouter un nouveau service destinataire</p>
        </div>
    </div>
