...
<head>
    ...
    <title>@yield('title', 'Tableau de bord') - SENDAPTNAPT</title>
            ...
            @if(session('impersonating'))
                <div class="bg-orange-500 text-white px-4 py-2 text-center text-sm font-medium">
                    <div class="flex items-center justify-center gap-4">
                        ...
                        <span>Vous simulez l'utilisateur <strong>{{ auth()->user()->full_name }}</strong> ({{ auth()->user()->matricule }})</span>
                        <a href="{{ route('impersonate.stop') }}" class="inline-flex items-center gap-1 bg-white text-orange-600 px-3 py-1 rounded-md text-xs font-bold hover:bg-orange-100 transition">
